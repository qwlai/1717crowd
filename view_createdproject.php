			...
			<ul class="pagination">
				<?php 					
					...
					if ($current_page == 1) {	
						...
						echo "<li class='page-item'><a class='page-link' href='view_createdproject.php?page=".$previous."'>Previous</a></li>";
					}
					...
					for ($i=1; $i <= $total_pages; $i++) {
						if ($i == $current_page) {
							...
							echo "<li class='page-item'><a class='page-link' href='view_createdproject.php?page=".$i."'>".$i."</a></li>";
						}
					}
					...
					if ($current_page == $total_pages) {
						...
						echo "<li class='page-item'><a class='page-link' href='view_createdproject.php?page=".$next."'>Next</a></li>";
					}
				?>
			</ul>
		</nav>	
